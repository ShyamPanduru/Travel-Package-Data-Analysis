...
The main objective is to understand pricing patterns, discount strategies, trip durations, and customer savings across different travel packages. Travelling analysis ppt updated
...
Dataset Information: The dataset contains 1000 rows and 9 columns representing travel package details.

Web Scraping Travel package data was collected from Travel Triangle website using Python. Travelling analysis ppt updated
*Steps performed:
...
1. Removed currency symbols (₹) and commas
2. Converted price columns to numeric format
3. Extracted numeric values using Regex
4. Separated trip duration into Days and Nights
5. Handled missing values and removed unnecessary columns

Feature Engineering New variables were created to improve analysis.
Savings
...
Exploratory Data Analysis (EDA) EDA was performed to understand patterns in travel package pricing. Travelling analysis ppt updated
